...
local s = f:section(Section, nil, translate(
		'This allows you to add a wifi interface with an alternative gateway '
...
local exit4 = s:option(Value, "exit4", translate("Exit ID (MAC)"))
...
local exit6 = s:option(Value, "exit6", translate("Exit ID (MAC)"))
...
local altesc_on_lan = s:option(Flag, "altesc_on_lan", translate("Enable redirection on LAN"))
